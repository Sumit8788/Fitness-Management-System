      ...
      <div className="style-prefix-147h429 center">
        <div class="style-prefix-5m47ckv bringCenter">
          ...
          <div className=" lefttMost">
            ...
            <h3 className="fontBold">IN <b class="h1maintitlecolor fontBold"> TechFit</b></h3>

            <p>
              <h5>
                We use a variety of holistic methods to keep you active and healthy.
                Exercise ,Yoga and basic medical services are available.
              </h5>
            </p>
          </div>
        </div>
